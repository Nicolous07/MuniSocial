      ...
      <div className={`flex-1 grid grid-cols-1 md:grid-cols-12 rounded-3xl border overflow-hidden min-h-[550px] sm:min-h-[620px] ${
          ...
          <div className="p-3 border-b border-slate-200 dark:border-slate-800">
            <div className={`relative flex items-center rounded-xl border px-3 py-1.5 ${
              ...
              <input 
                ...
                className="w-full bg-transparent border-0 text-xs focus:outline-none text-slate-900 dark:text-white placeholder-slate-500 font-medium"
              />
            </div>
          </div>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-0.5">
                      ...
                      <span className={`text-[10px] font-mono ${isActive ? 'text-indigo-100' : 'text-slate-500 dark:text-slate-400'}`}>
                        {thread.time}
                      </span>
                    </div>
                    <p className={`text-xs truncate ${isActive ? 'text-indigo-100' : 'text-slate-600 dark:text-slate-400'}`}>
                      {thread.lastMessage}
                    </p>
                  </div>
        ...
        <div className="md:col-span-8 flex flex-col h-full bg-transparent">
              ...
              return (
                <div key={m.id} className={`flex gap-2.5 ${isMe ? 'flex-row-reverse' : ''}`}>
                  ...
                  <div className={`max-w-[80%] sm:max-w-[70%] rounded-2xl p-3.5 text-xs space-y-1 shadow-sm ${
                    isMe 
                      ...
                      : m.isAi 
                        ? isDarkMode 
                          ...
                          : 'bg-indigo-50 border border-indigo-200 text-indigo-950 rounded-tl-none'
                        : isDarkMode 
                    ...
                    <p className="whitespace-pre-wrap leading-relaxed font-normal">{m.text}</p>
                    {isMe && (
          ...
          <div className={`px-4 py-2 border-t flex items-center gap-1.5 overflow-x-auto no-scrollbar ${
            ...
            <span className="text-[10px] font-mono text-indigo-600 dark:text-indigo-400 shrink-0 flex items-center gap-1">
            ...
            {[
              ...
              <button
                ...
                className="px-2.5 py-1 rounded-full bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-700 dark:text-indigo-300 text-[11px] font-medium border border-indigo-500/20 shrink-0 transition-colors"
              >
                {prompt}
              </button>
            ))}
          ...
          <form onSubmit={handleSend} className={`p-3 border-t flex items-center gap-2 ${
            ...
            <button 
              ...
              className="p-2 rounded-xl text-slate-400 hover:text-indigo-500 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors shrink-0"
            ...
            {isRecordingVoice ? (
              ...
              <input
                ...
                className={`flex-1 px-4 py-2.5 rounded-2xl border text-xs text-slate-900 dark:text-white placeholder-slate-500 dark:placeholder-slate-400 focus:outline-none focus:border-indigo-500 font-medium ${
